...
import de.datatrain.coan.R
import de.datatrain.coan.SimpleActivity
import de.datatrain.coan.app.ConfigurationData
import de.datatrain.coan.app.ErrorHandler
import de.datatrain.coan.app.ErrorMessage
import de.datatrain.coan.app.SAPWizardApplication
import de.datatrain.coan.service.SAPServiceManager
...
class LogonActivity: AppCompatActivity() {
    ...
    private fun startSimpleActivity() {
        sapServiceManager!!.openODataStore {
            val intent = Intent(this@LogonActivity, SimpleActivity::class.java)
